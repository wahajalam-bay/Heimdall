...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Work orders", href: "/work-orders", icon: "order", perms: [P.WORK_ORDER_VIEW] },
      { label: "Contracts", href: "/contracts", icon: "verified", perms: [P.PO_VIEW] },
      ...
      { label: "Costing (FIFO)", href: "/inventory/costing", icon: "inventory", perms: [P.INVENTORY_VIEW] },
      { label: "Replenishment", href: "/inventory/replenishment", icon: "inventory", perms: [P.INVENTORY_VIEW] },
      { label: "Stacking", href: "/inventory/stacking", icon: "store", perms: [P.INVENTORY_VIEW] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Delegations", href: "/admin/delegations", icon: "users", perms: [P.USER_MANAGE, P.ROLE_MANAGE, P.AUDIT_VIEW] },
      { label: "Access review", href: "/admin/access-review", icon: "verified", perms: [P.USER_MANAGE, P.ROLE_MANAGE, P.AUDIT_VIEW] },
