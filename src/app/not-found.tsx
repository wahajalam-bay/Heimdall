  ...
  return (
    <main className="grid min-h-dvh place-items-center px-6 py-16">
      <div className="max-w-md text-center">
        <span
          className="mx-auto mb-4 flex size-8 items-center justify-center rounded-[var(--radius-md)] text-xs font-700 text-white"
        ...
        <p className="mt-2 text-[0.8125rem] leading-5 text-[var(--c-text-secondary)]">
