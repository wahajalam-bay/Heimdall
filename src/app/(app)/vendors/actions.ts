...
function vendorFields(formData: FormData) {
  return {
    ...
    referredByName: blank(formData.get("referredByName")),
    referredByDesignation: blank(formData.get("referredByDesignation")),
    relatedCompanies: blank(formData.get("relatedCompanies")),
